...
<head>
	...
	<!-- start: Favicon -->
	<link rel="shortcut icon" href="{{asset('extra')}}/img/favicon.ico">
	<!-- end: Favicon -->
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="{{URL::to('/logo_link')}}"><span>Metro</span></a>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown hidden-phone">
							...
							<ul class="dropdown-menu messages">
                            	...
                            	<li>
                                    <a href="#">
										<span class="avatar"><img src="{{asset('extra')}}/img/avatar.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Łukasz Holeczek
										     </span>
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="{{asset('extra')}}/img/avatar2.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Megan Abott
										     </span>
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="{{asset('extra')}}/img/avatar3.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Kate Ross
										     </span>
								...
								<li>
                                    <a href="#">
										<span class="avatar"><img src="{{asset('extra')}}/img/avatar4.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Julie Blank
										     </span>
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="{{asset('extra')}}/img/avatar5.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Jane Sanders
										     </span>
...
//
        ...
        $admin=Session::get('admin_email');
         $admin_profile=DB::table('tb1_admin')

                      ->where('admin_email',$admin)
                      ->first();
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="{{URL::to('/admin_sideber_dashboard')}}"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>
            ...
            <li><a href="{{URL::to('/add_brand')}}"><i class="icon-dashboard"></i><span class="hidden-tablet">Add Brand</span></a></li>
						...
						<li><a href="{{URL::to('/add_slider')}}"><i class="icon-edit"></i><span class="hidden-tablet">Add Slider</span></a></li>
					  <li><a href="{{URL::to('/all_slider')}}"><i class="icon-edit"></i><span class="hidden-tablet">All Slider</span></a></li>
						<li><a href="{{URL::to('/manage_order')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">Manage Order</span></a></li>
						<li><a href="typography.html"><i class="icon-font"></i><span class="hidden-tablet">Delivery Man</span></a></li>
          		<li><a href="icon.html"><i class="icon-star"></i><span class="hidden-tablet">Social Link</span></a></li>
...
@yield('admin_content')
	...
	<footer>
		...
		<p>
			...
			<span class="hidden-phone" style="text-align:right;float:right">Powered by: <a href="" alt="Bootstrap Admin Templates">Metro</a></span>
		</p>
	...
	<script src="js/jquery.flot.resize.min.js"></script>
		...
		<script src="{{asset('extra')}}/js/bootbox.min.js"></script>
