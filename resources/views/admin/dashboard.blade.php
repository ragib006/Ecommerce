...
@section('admin_content')
     ...
     <div class="row-fluid">
       ...
       <div class="span3 statbox purple" onTablet="span6" onDesktop="span3">
         ...
         <div class="number">{{$visitor}}<i class="icon-arrow-up"></i></div>
       ...
       <div class="span3 statbox green" onTablet="span6" onDesktop="span3">
         ...
         <div class="number">{{ $order }}<i class="icon-arrow-up"></i></div>
       ...
       <div class="span3 statbox blue noMargin" onTablet="span6" onDesktop="span3">
         ...
         <div class="number">{{ $payment }}<i class="icon-arrow-up"></i></div>
       ...
       <div class="span3 statbox yellow" onTablet="span6" onDesktop="span3">
         ...
         <div class="number">{{ $due }}<i class="icon-arrow-down"></i></div>
       ...
       <div class="widget span3 red" onTablet="span6" onDesktop="span3">
         ...
         <div class="content">
           ...
           <div class="browserStat big">
             <img src="{{asset('extra')}}/img/browser-chrome-big.png" alt="Chrome">
             <span>34%</span>
           </div>
           <div class="browserStat big">
             <img src="{{asset('extra')}}/img/browser-firefox-big.png" alt="Firefox">
             <span>34%</span>
           </div>
           <div class="browserStat">
             <img src="{{asset('extra')}}/img/browser-ie.png" alt="Internet Explorer">
             <span>34%</span>
           </div>
           <div class="browserStat">
             <img src="{{asset('extra')}}/img/browser-safari.png" alt="Safari">
             <span>34%</span>
           </div>
           <div class="browserStat">
       ...
       <div class="box black span4" onTablet="span6" onDesktop="span4">
         ...
         <div class="box-content">
           <ul class="dashboard-list metro">
             <li class="green">
               <a href="#">
                 <img class="avatar" alt="Lucas" src="{{asset('extra')}}/img/avatar.jpg">
               </a>
             ...
             <li class="yellow">
               <a href="#">
                 <img class="avatar" alt="Bill" src="{{asset('extra')}}/img/avatar9.jpg">
               </a>
             ...
             <li class="red">
               <a href="#">
                 <img class="avatar" alt="Jane" src="{{asset('extra')}}/img/avatar5.jpg">
               </a>
             ...
             <li class="blue">
               <a href="#">
                 <img class="avatar" alt="Kate" src="{{asset('extra')}}/img/avatar6.jpg">
               </a>
